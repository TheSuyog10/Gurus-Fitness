...
<body style="background-color:#588b8b !important;">
    @if(session('alert'))
    <script>
        swal("Success", "{{ session('alert') }}", "success");
    </script>
@endif
    <div class="container">
        ...
        <div class="form">
            <div class="contact-info">
                ...
                <p class="text">
                  Have any fitness query, Don't hesitate to reach out to us.
                </p>
                <div class="info">
            ...
            <div class="contact-form">
                ...
                <form  autocomplete="off" method="POST" action ="/contact_info" enctype="multipart/form-data">
                    @csrf
                    <h3 class="title">Contact us</h3>
                    
                    @if ($errors->any())
                    <div id="error-message" class="alert alert-danger" style="text-align:center;color:maroon; font-weight:400">
                        <ul>
                            <li><i class="fa-solid fa-triangle-exclamation" style="color: #b92727;"></i> {{ $errors->first()}}</li> 
                        </ul>
                    </div>
                @endif
